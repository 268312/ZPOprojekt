...
import com.example.projektzpo.databinding.FragmentAvatarBinding
...
class AvatarFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.avatarBack.setOnClickListener {
            findNavController().navigate(R.id.action_AvatarFragment_to_SecondFragment)
        }
